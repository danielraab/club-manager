      ...
      <span class="flex items-center">
        ...
        <!--
          ...
          Leaving: "transition ease-in duration-100"
            ...
            To: "opacity-0"
        -->
        <ul x-cloak class="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
            tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-3" x-show="showList">
            <!--
