        ...
        <div class="flex fixed left-0 top-0 bottom-0 z-[100]">
            <div class="flex flex-col bg-white border-r p-5 min-w-[310px]"
                ...
                <div class="flex gap-2 justify-center items-center font-semibold">
                    ...
                    @php($appName = \App\Models\Configuration::getString(\App\Models\ConfigurationKey::APPEARANCE_APP_NAME, default: config('app.name', 'Club management'))) {{-- add setting to show or hide app name --}}
                    @if($appName)
