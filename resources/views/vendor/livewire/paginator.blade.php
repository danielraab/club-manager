@if ($paginator->hasPages())
    <nav role="navigation" aria-label="Pagination Navigation" class="w-full">
        <div class="flex gap-3 items-center justify-center flex-1 sm:hidden">
                <span>
                    ...
                    @else
                        <button type="button" wire:click="resetPage()" wire:loading.attr="disabled"
            ...
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    ...
                    @php($pages = ceil($paginator->total()/$paginator->perPage()))
            ...
            <span>
                    ...
                    <button type="button" wire:click="gotoPage('{{ $pages }}')" wire:loading.attr="disabled"
                            class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center gap-3">
            <div>
                <p class="text-sm text-gray-700 leading-5">
            ...
            @if(isset($this->availablePageSizes) && isset($this->pageSize)  && is_array($this->availablePageSizes))
                <x-input-label><span>{{__("Pagesize")}}: </span>
                <x-select wire:model.live="pageSize" class="self-end">
                    @foreach($this->availablePageSizes as $pageSize)
