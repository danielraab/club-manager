...
class Events extends Component
{
    ...
    {
        $this->eventStartToday = Configuration::getBool(ConfigurationKey::EVENT_FILTER_DEFAULT_START_TODAY, default: false);
        $this->birthdaysInPublicICS = Configuration::getBool(ConfigurationKey::EVENT_BIRTHDAYS_IN_ICS_EXPORT, default: false);
