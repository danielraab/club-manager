...
Route::middleware(['auth', 'verified', 'permission:'.UserPermission::USER_MANAGEMENT_SHOW_PERMISSION.'|'.UserPermission::USER_MANAGEMENT_EDIT_PERMISSION])->group(function () {
    Route::get('/userManagement', [UserOverview::class, 'index'])
        ->name('userManagement.index');
});
Route::middleware(['auth', 'verified', 'permission:'.UserPermission::USER_MANAGEMENT_EDIT_PERMISSION])->group(function () {
